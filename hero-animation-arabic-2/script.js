// Same reveal animation as the original "Nova Vice" demo, in Arabic (RTL).
// Uses the self-hosted globals: gsap, CustomEase, SplitType, projectsData.
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Split by WORDS (not chars) — Arabic is a connected script, so splitting
  // into characters would break the letter joins.
